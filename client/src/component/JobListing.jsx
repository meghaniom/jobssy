...
const JobListing = () => {
  ...
  const [filterJobs, setFiltersJobs] = useState(jobs);

  // Prevent crash if context is not initialized
  ...
  useEffect(() => {
    ...
    const matcheSearchLocation = (job) =>
      searchFilter.location === " " ||
      job.location.toLowerCase().includes(searchFilter.location.toLowerCase());

    const newFiltredJobs = jobs
      .slice()
      .reverse()
      .filter(
        (job) =>
          ...
          matchesTitle(job) &&
          matcheSearchLocation(job)
      );
    setFiltersJobs(newFiltredJobs);
